// schemaTypes/objects/VideoObject.ts
...
export const VideoObject = defineType({
  ...
  fields: [
    ...
    // Always show both fields - remove the hidden conditions temporarily
    defineField({
      name: 'videoFile', 
      title: 'Upload Video File', 
      type: 'file',
      description: 'Upload a video file from your device (only used if "Upload File" is selected above).',
      options: {
        accept: 'video/*'
      },
    }),
    defineField({
      ...
      title: 'Video URL',
      type: 'url',
      description: 'Enter the URL of your video - YouTube, Vimeo, direct link, etc. (only used if "External URL" is selected above).',
    }),
    defineField({
      name: 'isFeatured',
      title: 'Is Featured',
